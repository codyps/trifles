...
\lstinputlisting[language=C,style=eclipse]{p1.c}
...
\lstinputlisting[language=C,style=eclipse,caption=config.h]{config.h}
\lstinputlisting[language=C,style=eclipse,caption=p2.c]{p2.c}

\subsubsection{The obtained output}

\verbatiminput{p2.out}
